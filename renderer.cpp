...
u08 vg_80[] PROGMEM = { 0xFF }; 
                      // { 0x01,0x90,0xC0,0xD1, 0x01,0x83,0x94,0xC4,0xD3, 0x27,0xC7,0xD6,  0x34,0xDE };  // HP 3588A draws spurious € cedilla characters, so we render them as blanks
...
double u,du,      // parameter u varied from 0 to 1
...
///gl_spacex /= 32.0;
   ...
   gl_label_index = strlen((char *) buf);
   gl_label_start = 0;
