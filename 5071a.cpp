...
void main(int argc, char **argv)
{
   ...
   fprintf(stderr,"\n5071A version %s of %s by John Miles, KE5FX\n"
   ...
   if (argc < 3)
      ...
      fprintf(stderr,"This program retrieves a status report from an HP 5071A primary frequency\n"
                     ...
                     "operating mode\n"
//                     "\n     5071A com5 2400 csoff local\n\n"  // TODO
//                     "sets the clock using the PC's current local time\n");
                     "");
      exit(1);
      }
   ...
   //
   // Reset continuous-operation LED
   //
         
   serial.printf("DIAG:CONT:RES\n"); serial.gets(); serial.gets(); 
}
