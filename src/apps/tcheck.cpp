...
C8 *sanitize_path(C8 *input, S32 allow_colons_quotes_and_backslashes, S32 allow_periods)
{
   ...
   for (S32 i=0; i < len; i++)
      ...
      switch (s)
         {
         case (char) 0x80: d = 'C'; break;
         case (char) 0x81: d = 'u'; break;
         case (char) 0x82: d = 'e'; break;
         case (char) 0x83: d = 'a'; break;
         case (char) 0x84: d = 'a'; break;
         case (char) 0x85: d = 'a'; break;
         case (char) 0x86: d = 'a'; break;
         case (char) 0x87: d = 'c'; break;
         case (char) 0x88: d = 'e'; break;
         case (char) 0x89: d = 'e'; break;
         case (char) 0x8a: d = 'e'; break;
         case (char) 0x8b: d = 'i'; break;
         case (char) 0x8c: d = 'i'; break;
         case (char) 0x8d: d = 'i'; break;
         case (char) 0x8e: d = 'A'; break;
         case (char) 0x8f: d = 'A'; break;
         case (char) 0x90: d = 'E'; break;
         case (char) 0x91: d = 'o'; break;
         case (char) 0x92: d = 'o'; break;
         case (char) 0x93: d = 'o'; break;
         case (char) 0x94: d = 'u'; break;
         case (char) 0x95: d = 'u'; break;
         case (char) 0x96: d = 'y'; break;
         case (char) 0x97: d = 'o'; break;
         case (char) 0x98: d = 'u'; break;
         case (char) 0x99: d = 'c'; break;
         case (char) 0x9a: d = '$'; break;
         case (char) 0x9b: d = 'Y'; break;
         case (char) 0x9c: d = 'f'; break;
         case (char) 0x9d: d = 'a'; break;
         case (char) 0x9e: d = 'i'; break;
         case (char) 0x9f: d = 'o'; break;
         case (char) 0xa0: d = 'u'; break;
         case (char) 0xa1: d = 'n'; break;
         case (char) 0xa2: d = 'n'; break;    
         case '-':            ok = 1; break;
         case '_':            ok = 1; break;
         case '~':            ok = 1; break;
         case '&':            ok = 1; break;
...
";
   ...
   // suffixes[fn.nFilterIndex-1].  (This previously had .tga/.bmp swapped
   // relative to the filter, and lacked .png entirely.)
   C8 *suffixes[] =
      {
      ".gif",
      ".png",
...
bool load_file(C8 *filename)
{
   ...
   if (filename[0])
      ...
      if (prev != NULL)
         {
         DOUBLE min_margin = std::max(prev->S->min_Hz, sp->min_Hz) / 10000.0;
