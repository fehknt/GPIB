...
In addition to running interactively, 7470 can acquire a single plot and save it without user interaction, which is useful for scripting and for testing against real hardware. Run `7470 -?` for the full list.
